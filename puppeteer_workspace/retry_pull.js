...
(async () => {
  try {
    ...
    console.log('Sending docker compose pull again...');
    await orcaPage.keyboard.type('sudo docker compose pull aitoearn-web\n');
    
    // Wait 60 seconds for pull to complete
    console.log('Waiting 60 seconds for pull...');
    await new Promise(r => setTimeout(r, 60000));

    const screenshotPath = `C:\\Users\\Admin\\.gemini\\antigravity\\brain\\7c16e4e3-439e-4dd6-b1e6-a7b47ace866d\\scratch\\remote_pull_retry.png`;
