...
(async () => {
  console.log('🚀 Running detailed cloud logs filter diagnostics...');
  try {
    ...
    // Fetch filtered logs
    const logsCmd = "sudo docker compose logs --tail=500 aitoearn-ai | grep -i -E 'error|exception|fail' -C 3";
    ...
    const diagPath = path.join(artifactDir, 'cloud_detailed_err.png');
    ...
    console.error('Error during detailed logs diagnostics:', err);
  }
})();
