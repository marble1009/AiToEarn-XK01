...
(async () => {
  try {
    ...
    // Type `sudo docker compose restart nginx`
    console.log('🔄 Restarting nginx container to refresh dynamic IP cache...');
    ...
    const screenshotPath = path.join(artifactDir, 'scratch', 'restart_nginx_correct.png');
