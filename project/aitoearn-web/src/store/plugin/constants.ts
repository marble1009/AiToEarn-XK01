...
export const PLUGIN_DOWNLOAD_LINKS = {
  chrome:
    'https://chromewebstore.google.com/detail/aiautoedit-extension/hnmocdhmnfgcjnedmdgfefcobideaeja',
  china: 'https://ai-to-earn.oss-cn-beijing.aliyuncs.com/comment/aiautoedit-extension.crx',
} as const
