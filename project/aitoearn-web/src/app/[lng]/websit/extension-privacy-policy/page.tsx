 ...
 * 展示 aiautoedit 浏览器扩展的隐私政策和数据收集说明
 */
      ...
      <main className={styles.main}>
        <div className={styles.container}>
          <div className={styles.header}>
            <h1 className={styles.title}>aiautoedit Extension Privacy Policy</h1>
          ...
          <div className={styles.content}>
            <section className={styles.section}>
              <p className={styles.introduction}>
                This Privacy Policy describes how aiautoedit Extension ("Extension", "we", "us", or
                "our") collects, uses, and protects information when you use our browser extension.
                By installing and using the aiautoedit Extension, you agree to the collection and use
            ...
            <section className={styles.section} id="section1">
              ...
              <p className={styles.sectionContent}>
                aiautoedit Extension is a browser extension designed to help users automate content
                publishing, engagement, and social media tasks seamlessly with the aiautoedit web
                platform (https://aiautoedit.art). The extension works in conjunction with supported
            ...
            <section className={styles.section} id="section3">
              ...
              <p className={styles.sectionContent}>
                The aiautoedit Extension requires certain browser permissions to function. Here's why
              ...
              <ul className={styles.listContent}>
                ...
                <li>aiautoedit.art - For communication with aiautoedit web platform</li>
              </ul>
            </section>
            ...
            <section className={styles.section} id="section4">
              ...
              <ul className={styles.listContent}>
                ...
                <li>To synchronize data with the aiautoedit web platform</li>
            ...
            <section className={styles.section} id="section5">
              ...
              <p className={styles.sectionContent}>
                Certain data may be transmitted to and stored on aiautoedit servers to enable
            ...
            <section className={styles.section} id="section7">
              ...
              <h3 className={styles.subSectionTitle}>With aiautoedit Platform</h3>
              <p className={styles.sectionContent}>
                Data is shared between the extension and the aiautoedit web platform to provide
              ...
              <p className={styles.sectionContent}>
                ...
                request, or to protect the rights, property, or safety of aiautoedit, our users, or
                others.
              </p>
            </section>
